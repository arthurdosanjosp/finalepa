...
export default function App() {
  ...
  const handlePress = (screen) => {
    router.push(`/${screen}`); // Navega para a tela especificada
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.card, { opacity: fadeAnim1 }]}>
        <TouchableOpacity onPress={() => handlePress('salgados')} style={[styles.button, { backgroundColor: '#42A5F5' }]}>
      ...
      <Animated.View style={[styles.card, { opacity: fadeAnim2 }]}>
        <TouchableOpacity onPress={() => handlePress('frutas')} style={[styles.button, { backgroundColor: '#FFA500' }]}>
          <Text style={styles.buttonText}></Text> {/* Texto do botão */} 
        </TouchableOpacity>
      ...
      <Animated.View style={[styles.card, { opacity: fadeAnim3 }]}>
        <TouchableOpacity onPress={() => handlePress('doces')} style={[styles.button, { backgroundColor: '#800080' }]}>
          <Text style={styles.buttonText}></Text> {/* Texto do botão */} 
        </TouchableOpacity>
